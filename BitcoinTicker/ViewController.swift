...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    let currencyArray = ["AUD", "BRL","CAD","CNY","EUR","GBP","HKD","IDR","ILS","INR","JPY","MXN","NOK","NZD","PLN","RON","RUB","SEK","SGD","USD","VND","ZAR"]
...
//
    func updateBitcoinData (json : JSON) {
        ...
        if let priceResult = json["bid"].double {
            ...
            bitcoinPriceLabel.text = "Bitcoin Price Unvailable"
        }
    }
